...
const RAW_BASE = import.meta.env.VITE_API_BASE_URL || "https://fawaz-law-firm.apphub.my.id";
...
const Cases = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      ...
      const currentLocale = (lng || "ar").split("-")[0];

      const headers = {
        "Content-Type": "application/json",
        // ✅ IMPORTANT: send locale
  ...
  }, [t, lng]); // ✅ refetch when locale changes
